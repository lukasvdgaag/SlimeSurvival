...
public class SlimeBoard {
    ...
    public SlimeBoard(Player player, int lineCount) {
        this.player = player;
        this.lineCount = lineCount;
        this.board = SlimeSurvival.get().getServer().getScoreboardManager().getNewScoreboard();
    ...
    public void setLine(int arg0, String arg1) {
        ...
        if (SlimeSurvival.getNMS().getVersion() > 12) arg3 = convertIntoPieces(arg1, 64);
